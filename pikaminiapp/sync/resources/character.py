"""Synchronous character resource."""
...
class CharacterResource:
    """Resource for character-related API operations."""

    def __init__(self, http: SyncHTTPClient):
        self._http = http

    def get_blueprint(self, character_id: str) -> CharacterItem:
    ...
    def upsert_blueprint_state(
        ...
        data = self._http.post("/miniapp/character/blueprint/state", payload)
        return CharacterItem.model_validate(data["character"])
